...
# # # # # # # #         font_size = data['font_size']
# # # # # # # #         position = data['position']
# # # # # # # #         text_color = data.get('text_color', 'N/A')
# # # # # # # #         altered_size = data.get('altered_size', 'N/A')
...
# # # # # # # #             image_name = st.text_input(f"Enter name for Image {i+1}", f"Image {i+1}")
# # # # # # # #             font_size = st.number_input(f"Enter font size for Image {i+1}", min_value=1, max_value=200, value=30)
# # # # # # # #             position = st.selectbox(f"Select position for Image {i+1}", ('top-left', 'bottom-left', 'bottom-right'))
# # # # # # # #             text_color = st.color_picker(f"Select text color for Image {i+1}", '#000000')
# # # # # # # #             altered_size = st.checkbox(f"Image {i+1} size altered")
...
# # # # # # # #             st.image(image_with_overlay)

# # # # # # # #         if st.button('Process and Save'):
# # # # # # # #             response = save_to_history(image_data_list)
# # # # # # # #             st.success(response['message'])

# # # # # # # #     st.subheader('History')
# # # # # # # #     history_data = load_json_data()
# # # # # # # #     history_html = generate_html(history_data)
# # # # # # # #     st.write(history_html)
